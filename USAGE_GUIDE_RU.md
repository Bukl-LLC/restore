...
### ✅ Landing Page
- Красивая главная страница с информацией об услугах credit repair
- Описание преимуществ и процесса работы
- Статистика и отзывы
- CTA кнопки для регистрации

### ✅ Регистрация и модуль приема заявок
- Страница регистрации с формой создания аккаунта
- После регистрации - переход на форму заявки
